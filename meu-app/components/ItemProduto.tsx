      ...
      >
         <View style={estilos.cabecalhoCartao}>
            <View style={estilos.detalhesProduto}>
               ...
               <Text style={estilos.produtoDescricao}>{props.item.descricao}</Text>
            </View>
            <TouchableOpacity
         ...
         <View style={estilos.fileiraInfo}>
            <Text style={estilos.produtoPreco}>
               R$ {Number(props.item.preco).toFixed(2)}
            </Text>
            <Text style={estilos.produtoEstoque}>
               Estoque: {props.item.estoque} un.
            </Text>
         </View>
...
const estilos = StyleSheet.create({
   ...
   produtoDescricao: { fontSize: 13, color: '#666' },
   ...
   produtoPreco: { fontSize: 13, color: '#2e7d32', fontWeight: 'bold' },
   produtoEstoque: { fontSize: 13, color: '#ed6c02' },
